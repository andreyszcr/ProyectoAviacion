<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contactenos.aspx.cs" Inherits="Aviacion.Contactenos" %>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-5 mb-5">Si tienes dudas contactanos!!!</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h3 class="mb-4">Necesitas Informacion?</h3>
                    <p class="mb-4">Contactanos para que puedas obtener mas informacion</p>
